...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["profile_image", "created_at"]
        extra_kwargs = {
...
class UserWithoutPasswordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'username', 'email', 'is_admin', 'is_mentor', 'is_active', 'last_login', 'profile_image', 'point', 'career', 'status_message']
